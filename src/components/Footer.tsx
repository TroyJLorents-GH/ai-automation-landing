...
const Footer: React.FC = () => {
  ...
  const footerLinks = {
    services: [
      { name: 'Customer Service Automation', href: '#services' },
      { name: 'Data Entry Automation', href: '#services' },
      { name: 'Appointment Scheduling', href: '#services' },
      { name: 'Email Management', href: '#services' },
      ...
      <div className="container mx-auto px-6 py-16">
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              <span className="text-blue-400">Automate</span>Flows
            </motion.a>
            <p className="text-gray-400 mb-6 max-w-sm leading-relaxed">
              Helping small businesses save time and reduce costs through intelligent AI-powered automation solutions.
            </p>
            <div className="flex gap-4">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 bg-gray-800 hover:bg-blue-600 rounded-lg flex items-center justify-center text-gray-400 hover:text-white transition-all duration-200"
          ...
          {/* Company */}
          <div>
            <h4 className="text-white font-display font-semibold mb-5">Company</h4>
            <ul className="space-y-3">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-white font-display font-semibold mb-5">Legal</h4>
            <ul className="space-y-3">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {currentYear} Automate Flows. All rights reserved.
            </p>
